...
import droid.airplay.network.raop.RaopRtpPacket.TimingRequest;
...
import droid.airplay.audio.AudioClock;
import droid.airplay.network.RunningExponentialAverage;
